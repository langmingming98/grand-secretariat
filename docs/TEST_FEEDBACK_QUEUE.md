...
| TQ-021 | `P2` | Room presets | Create new room | Preset templates for quick room creation (e.g., "AI Safety Council") | No presets, manual entry only | `fixed_pending_verification` | Added 4 presets: AI Safety Council, System Design Review, Blank Room, 三杨内阁 |
